...
# Deploying Warehouse Inventory Management on AWS

#### Overview

In this workshop, we will build and deploy the **Warehouse Inventory Management** application using a cloud-native architecture on AWS.
